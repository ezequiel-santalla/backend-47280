...
export class ProductManager {
	...
	async addProduct(product) {
		...
		if (!title || !description || !price || !thumbnail || !code || !stock) {
			console.log("The product must include the fields title, description, price, thumbnail, code and stock")

			return
		}

		this.products.find(element => element.code == product.code)
			? console.log("Product code already exists") : this.products.push(product)
